...
export default function FAQs() {
    ...
    const questions = [
        {
            question: "What is Career Genie?",
            answer: "Career Genie is an all-in-one platform that helps users build their careers with AI-powered tools. It provides career guidance, personalized roadmaps, portfolio creation, and interview preparation to make job hunting easier and more effective."
        },
        {
        ...
        {
            question: "Can I create my own portfolio using Career Genie?",
        ...
        {
            question: "Is Career Genie suitable for beginners?",
        ...
        },
        {
            ...
            answer: "No, Career Genie is user-friendly and requires no coding knowledge. The platform is designed for everyone, from tech professionals to non-tech users."
        },
        {
            question: "Is Career Genie free to use?",
        ...
        {
            question: "How do I get started with Career Genie?",
